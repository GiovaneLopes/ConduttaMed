...
class AclsHistoryDataPage extends StatelessWidget {
  const AclsHistoryDataPage({super.key});
        ...
        children: [
          ...
          IconButton(
            onPressed: () => showCustomDialog(
              context,
              title: 'Excluir',
              subtitle: 'Você tem certeza que deseja excluir?',
              confirmButtonLabel: 'Excluir',
              onConfirm: () {
                bloc.deleteHistoryItem(bloc.state.selected?.id ?? '');
                Modular.to
                    .popUntil(ModalRoute.withName(AclsRoutes.aclsHistory.path));
              },
            ),
            icon: Icon(
