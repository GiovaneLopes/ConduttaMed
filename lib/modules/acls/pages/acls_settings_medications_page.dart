...
class AclsSettingsMedicationsPage extends StatefulWidget {
  const AclsSettingsMedicationsPage({super.key});

  @override
  State<AclsSettingsMedicationsPage> createState() => _AclsSettingsMedicationsPageState();
}

class _AclsSettingsMedicationsPageState extends State<AclsSettingsMedicationsPage> {
  int? expandedIndex;
